...
public class SocketTests {
    ...
    /**
     * Получает информацию об изменении цен BTC-USDT в течении 10 секунд и проверяет,
     * что временые промежутки отличаются
     *
    ...
    public void socketUI_SendText() {
        ...
        String url = input.getAttribute("value"); //получаем ссылку на подключение к вебсокету
        button.click();
